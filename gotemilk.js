...
Date("Aug 3, 2020 23:59:59").getTime();var x = setInterval(function() {var now = new
...
{clearInterval(x);document.getElementById("timer").innerHTML = "Webstore Closed. Additional Purchases Will Be Reserved for Artwalk September 4th.";} }, 1000); 
