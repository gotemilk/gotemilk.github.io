...
Date("Aug 21, 2020 23:59:59").getTime();var x = setInterval(function() {var now = new
...
{clearInterval(x);document.getElementById("timer").innerHTML = "Thank you so much";} }, 1000); 
